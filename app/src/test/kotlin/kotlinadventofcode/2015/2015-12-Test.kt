...
class `2015-12-Test` {
    ...
    private infix fun String.when1runsWith(input: String) {
        assertEquals(this, `2015-12`().runPartOneNoUI(input))
    }

    private infix fun String.when2runsWith(input: String) {
        assertEquals(this, `2015-12`().runPartTwoNoUI(input))
    }

    @Test fun testDefaultPart1() {
        assertEquals("156366", `2015-12`().runPartOneNoUI())
    }

    @Test fun testDefaultPart2() {
        assertEquals("96852", `2015-12`().runPartTwoNoUI())
    }
