...
class `2015-15-Test` {
    ...
    private infix fun String.when1runsWith(input: String) {
        assertEquals(this, `2015-15`().runPart1(input))
    }

    private infix fun String.when2runsWith(input: String) {
        assertEquals(this, `2015-15`().runPart2(input))
    }

    @Test fun testDefaultPart1() {
        assertEquals("21367368", `2015-15`().runPart1())
    }

    @Test fun testDefaultPart2() {
        assertEquals("1766400", `2015-15`().runPart2())
    }
