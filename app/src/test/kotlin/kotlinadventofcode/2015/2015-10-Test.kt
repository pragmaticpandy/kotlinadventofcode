...
class `2015-10-Test` {
    ...
    private infix fun String.when1runsWith(input: String) {
        assertEquals(this, `2015-10`().runPartOneNoUI(input))
    }

    private infix fun String.when2runsWith(input: String) {
        assertEquals(this, `2015-10`().runPartTwoNoUI(input))
    }
    ...
    @Test fun testDefaultPart1() {
        assertEquals("252594", `2015-10`().runPartOneNoUI())
    }

    @Test fun testDefaultPart2() {
        assertEquals("3579328", `2015-10`().runPartTwoNoUI())
    }
