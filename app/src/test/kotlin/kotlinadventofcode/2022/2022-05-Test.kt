...
class `2022-05-Test` {
    ...
    private infix fun String.when1runsWith(input: String) {
        assertEquals(this, `2022-05`().runPart1(input))
    }

    private infix fun String.when2runsWith(input: String) {
        assertEquals(this, `2022-05`().runPart2(input))
    }

    @Test fun testDefaultPart1() {
        assertEquals("WSFTMRHPP", `2022-05`().runPart1())
    }

    @Test fun testDefaultPart2() {
        assertEquals("GSLCMFBRP", `2022-05`().runPart2())
    }
