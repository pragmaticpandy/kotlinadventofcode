...
class `2022-17-Test` {
    ...
    private infix fun String.when1runsWith(input: String) {
        assertEquals(this, `2022-17`().runPart1(input))
    }

    private infix fun String.when2runsWith(input: String) {
        assertEquals(this, `2022-17`().runPart2(input))
    }

    @Test fun testDefaultPart1() {
        assertEquals("3232", `2022-17`().runPart1())
    }

    @Test fun testDefaultPart2() {
        assertEquals("1585632183915", `2022-17`().runPart2())
    }
}
