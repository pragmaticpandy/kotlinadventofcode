...
class `2022-14-Test` {
    ...
    private infix fun String.when1runsWith(input: String) {
        assertEquals(this, `2022-14`().runPartOneNoUI(input))
    }

    private infix fun String.when2runsWith(input: String) {
        assertEquals(this, `2022-14`().runPartTwoNoUI(input))
    }

    @Test fun testDefaultPart1() {
        assertEquals("1001", `2022-14`().runPartOneNoUI())
    }

    @Test fun testDefaultPart2() {
        assertEquals("27976", `2022-14`().runPartTwoNoUI())
    }
