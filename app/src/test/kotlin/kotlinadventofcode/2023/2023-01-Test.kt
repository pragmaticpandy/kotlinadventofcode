...
class `2023-01-Test` {
    ...
    private infix fun String.when1runsWith(input: String) {
        assertEquals(this, `2023-01`().runPart1(input))
    }

    private infix fun String.when2runsWith(input: String) {
        assertEquals(this, `2023-01`().runPart2(input))
    }

    @Test fun testDefaultPart1() {
        assertEquals("54968", `2023-01`().runPart1())
    }

    @Test fun testDefaultPart2() {
        assertEquals("54094", `2023-01`().runPart2())
    }
