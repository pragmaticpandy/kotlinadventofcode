...
class `2023-01-Test` {
    ...
    private infix fun String.when1runsWith(input: String) {
        assertEquals(this, `2023-01`().runPartOneNoUI(input))
    }

    private infix fun String.when2runsWith(input: String) {
        assertEquals(this, `2023-01`().runPartTwoNoUI(input))
    }

    @Test fun testDefaultPart1() {
        assertEquals("54968", `2023-01`().runPartOneNoUI())
    }

    @Test fun testDefaultPart2() {
        assertEquals("54094", `2023-01`().runPartTwoNoUI())
    }
