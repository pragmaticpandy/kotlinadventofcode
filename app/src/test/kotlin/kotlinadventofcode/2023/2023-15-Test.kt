...
class `2023-15-Test` {
    ...
    private infix fun String.when1runsWith(input: String) {
        assertEquals(this, `2023-15`().runPart1(input))
    }

    private infix fun String.when2runsWith(input: String) {
        assertEquals(this, `2023-15`().runPart2(input))
    }

    @Test fun testDefaultPart1() {
        assertEquals("511257", `2023-15`().runPart1())
    }

    @Test fun testDefaultPart2() {
        assertEquals("239484", `2023-15`().runPart2())
    }
